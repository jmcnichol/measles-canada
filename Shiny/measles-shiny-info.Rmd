...
$q_{spep}$: the rate of quarantine and/or PEP for exposed people. 0 if no interventions.

- $q_{spep}$ = (1/**time to contact exposed people**) $\times$ (fraction PEP eligible) $\times$ (**acceptance rate of PEP**) $\times$ (effectiveness of PEP) </br>
